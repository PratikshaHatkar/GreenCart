            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (  
                           <img key={i} src={i<4 ? assets.star_icon : assets.star_dull_icon}
                            alt="" className='md:w-4 w-3.5'/>
                        ))}
                        <p className="text-base ml-2"></p>
                    </div>
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        className="w-full py-3.5 cursor-pointer font-medium bg-primary text-white hover:bg-primay-dull transition" >
                            Buy now
                        </button>
                    </div>
