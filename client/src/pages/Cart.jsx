...
const Cart = () => {
    const {products , currency , cartItems , removeFromCart, user ,setCartItems,
    getCartCount , updateCartItem , navigate , getCartAmount , axios} = useAppContext();
    ...
    const placeOrder = async () =>{
        try{
            ...
            if(paymentOption == "COD"){
                ...
                const {data:rzpOrderData} =
                    await axios.post(
                        "/api/v1/payment/process",
                        {amount}
                    );
            
                const razorpayOrder = rzpOrderData.order;
                ...
                const options = {
                    ...
                    handler: async function(response){
                        ...
                        if(orderResponse.data.success){
                            ...
                            toast.error(orderResponse.data.messsage)
                        }
